 ...
 */var Po=Symbol.for("react.element"),O0=Symbol.for("react.portal"),U0=Symbol.for("react.fragment"),B0=Symbol.for("react.strict_mode"),V0=Symbol.for("react.profiler"),G0=Symbol.for("react.provider"),H0=Symbol.for("react.context"),W0=Symbol.for("react.forward_ref"),j0=Symbol.for("react.suspense"),X0=Symbol.for("react.memo"),q0=Symbol.for("react.lazy"),ud=Symbol.iterator;function $0(t){return t===null||typeof t!="object"?null:(t=ud&&t[ud]||t["@@iterator"],typeof t=="function"?t:null)}var Vp={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Gp=Object.assign,Hp={};function Ss(t,e,n){this.props=t,this.context=e,this.refs=Hp,this.updater=n||Vp}Ss.prototype.isReactComponent={};Ss.prototype.setState=function(t,e){if(typeof t!="object"&&typeof t!="function"&&t!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,t,e,"setState")};Ss.prototype.forceUpdate=function(t){this.updater.enqueueForceUpdate(this,t,"forceUpdate")};function Wp(){}Wp.prototype=Ss.prototype;function Jc(t,e,n){this.props=t,this.context=e,this.refs=Hp,this.updater=n||Vp}var ef=Jc.prototype=new Wp;ef.constructor=Jc;Gp(ef,Ss.prototype);ef.isPureReactComponent=!0;var cd=Array.isArray,jp=Object.prototype.hasOwnProperty,tf={current:null},Xp={key:!0,ref:!0,__self:!0,__source:!0};function qp(t,e,n){var i,r={},s=null,o=null;if(e!=null)for(i in e.ref!==void 0&&(o=e.ref),e.key!==void 0&&(s=""+e.key),e)jp.call(e,i)&&!Xp.hasOwnProperty(i)&&(r[i]=e[i]);var a=arguments.length-2;if(a===1)r.children=n;else if(1<a){for(var l=Array(a),u=0;u<a;u++)l[u]=arguments[u+2];r.children=l}if(t&&t.defaultProps)for(i in a=t.defaultProps,a)r[i]===void 0&&(r[i]=a[i]);return{$$typeof:Po,type:t,key:s,ref:o,props:r,_owner:tf.current}}function Y0(t,e){return{$$typeof:Po,type:t.type,key:e,ref:t.ref,props:t.props,_owner:t._owner}}function nf(t){return typeof t=="object"&&t!==null&&t.$$typeof===Po}function K0(t){var e={"=":"=0",":":"=2"};return"$"+t.replace(/[=:]/g,function(n){return e[n]})}var fd=/\/+/g;function Ol(t,e){return typeof t=="object"&&t!==null&&t.key!=null?K0(""+t.key):e.toString(36)}function Ta(t,e,n,i,r){var s=typeof t;(s==="undefined"||s==="boolean")&&(t=null);var o=!1;if(t===null)o=!0;else switch(s){case"string":case"number":o=!0;break;case"object":switch(t.$$typeof){case Po:case O0:o=!0}}if(o)return o=t,r=r(o),t=i===""?"."+Ol(o,0):i,cd(r)?(n="",t!=null&&(n=t.replace(fd,"$&/")+"/"),Ta(r,e,n,"",function(u){return u})):r!=null&&(nf(r)&&(r=Y0(r,n+(!r.key||o&&o.key===r.key?"":(""+r.key).replace(fd,"$&/")+"/")+t)),e.push(r)),1;if(o=0,i=i===""?".":i+":",cd(t))for(var a=0;a<t.length;a++){s=t[a];var l=i+Ol(s,a);o+=Ta(s,e,n,l,r)}else if(l=$0(t),typeof l=="function")for(t=l.call(t),a=0;!(s=t.next()).done;)s=s.value,l=i+Ol(s,a++),o+=Ta(s,e,n,l,r);else if(s==="object")throw e=String(t),Error("Objects are not valid as a React child (found: "+(e==="[object Object]"?"object with keys {"+Object.keys(t).join(", ")+"}":e)+"). If you meant to render a collection of children, use an array instead.");return o}function Uo(t,e,n){if(t==null)return t;var i=[],r=0;return Ta(t,i,"","",function(s){return e.call(n,s,r++)}),i}function Z0(t){if(t._status===-1){var e=t._result;e=e(),e.then(function(n){(t._status===0||t._status===-1)&&(t._status=1,t._result=n)},function(n){(t._status===0||t._status===-1)&&(t._status=2,t._result=n)}),t._status===-1&&(t._status=0,t._result=e)}if(t._status===1)return t._result.default;throw t._result}var Bt={current:null},ba={transition:null},Q0={ReactCurrentDispatcher:Bt,ReactCurrentBatchConfig:ba,ReactCurrentOwner:tf};Pe.Children={map:Uo,forEach:function(t,e,n){Uo(t,function(){e.apply(this,arguments)},n)},count:function(t){var e=0;return Uo(t,function(){e++}),e},toArray:function(t){return Uo(t,function(e){return e})||[]},only:function(t){if(!nf(t))throw Error("React.Children.only expected to receive a single React element child.");return t}};Pe.Component=Ss;Pe.Fragment=U0;Pe.Profiler=V0;Pe.PureComponent=Jc;Pe.StrictMode=B0;Pe.Suspense=j0;Pe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Q0;Pe.cloneElement=function(t,e,n){if(t==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+t+".");var i=Gp({},t.props),r=t.key,s=t.ref,o=t._owner;if(e!=null){if(e.ref!==void 0&&(s=e.ref,o=tf.current),e.key!==void 0&&(r=""+e.key),t.type&&t.type.defaultProps)var a=t.type.defaultProps;for(l in e)jp.call(e,l)&&!Xp.hasOwnProperty(l)&&(i[l]=e[l]===void 0&&a!==void 0?a[l]:e[l])}var l=arguments.length-2;if(l===1)i.children=n;else if(1<l){a=Array(l);for(var u=0;u<l;u++)a[u]=arguments[u+2];i.children=a}return{$$typeof:Po,type:t.type,key:r,ref:s,props:i,_owner:o}};Pe.createContext=function(t){return t={$$typeof:H0,_currentValue:t,_currentValue2:t,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},t.Provider={$$typeof:G0,_context:t},t.Consumer=t};Pe.createElement=qp;Pe.createFactory=function(t){var e=qp.bind(null,t);return e.type=t,e};Pe.createRef=function(){return{current:null}};Pe.forwardRef=function(t){return{$$typeof:W0,render:t}};Pe.isValidElement=nf;Pe.lazy=function(t){return{$$typeof:q0,_payload:{_status:-1,_result:t},_init:Z0}};Pe.memo=function(t,e){return{$$typeof:X0,type:t,compare:e===void 0?null:e}};Pe.startTransition=function(t){var e=ba.transition;ba.transition={};try{t()}finally{ba.transition=e}};Pe.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};Pe.useCallback=function(t,e){return Bt.current.useCallback(t,e)};Pe.useContext=function(t){return Bt.current.useContext(t)};Pe.useDebugValue=function(){};Pe.useDeferredValue=function(t){return Bt.current.useDeferredValue(t)};Pe.useEffect=function(t,e){return Bt.current.useEffect(t,e)};Pe.useId=function(){return Bt.current.useId()};Pe.useImperativeHandle=function(t,e,n){return Bt.current.useImperativeHandle(t,e,n)};Pe.useInsertionEffect=function(t,e){return Bt.current.useInsertionEffect(t,e)};Pe.useLayoutEffect=function(t,e){return Bt.current.useLayoutEffect(t,e)};Pe.useMemo=function(t,e){return Bt.current.useMemo(t,e)};Pe.useReducer=function(t,e,n){return Bt.current.useReducer(t,e,n)};Pe.useRef=function(t){return Bt.current.useRef(t)};Pe.useState=function(t){return Bt.current.useState(t)};Pe.useSyncExternalStore=function(t,e,n){return Bt.current.useSyncExternalStore(t,e,n)};Pe.useTransition=function(){return Bt.current.useTransition()};Pe.version="18.2.0";(function(t){t.exports=Pe})(k0);const J0=F0(Fe);/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fi,depthTest:!1,depthWrite:!1})}function mp(){return new Rt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:nd(),fragmentShader:`
		...
		`,blending:Fi,depthTest:!1,depthWrite:!1})}function gp(){return new Rt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nd(),fragmentShader:`
...
`].filter(qs).join(`
`)),o=Yc(o),o=Tp(o,n),o=bp(o,n),a=Yc(a),a=Tp(a,n),a=bp(a,n),o=Cp(o),a=Cp(a),n.isWebGL2&&n.isRawShaderMaterial!==!0&&(g=`#version 300 es
...
`}}}class Ts{constructor(){this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const VE=new M0(-1,1,1,-1,0,1),id=new Xn;id.setAttribute("position",new ui([-1,3,0,-1,-1,0,3,-1,0],3));id.setAttribute("uv",new ui([0,2,0,0,2,0],2));class dl{constructor(e){this._mesh=new Gn(id,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,VE)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}const P0={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},GE={shaderID:"luminosityHighPass",uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Ge(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}ys.BlurDirectionX=new xe(1,0);ys.BlurDirectionY=new xe(0,1);const HE={uniforms:{damp:{value:.96},tOld:{value:null},tNew:{value:null}},vertexShader:`
...
`,Co=32,Up=1e4,ro=window.innerHeight/4,Hu=ro/2;let Jr,Ua,ii,Zc=0,Qc=0,rd=window.innerWidth/2,sd=window.innerHeight/2,Bp=performance.now(),Pn,yi,ti,sr,Lt,Ao,$s;Ao=new Rt({uniforms:{positionTex:{value:null},resolution:{value:new xe},width:{value:Co}},vertexShader:ZE,fragmentShader:QE});function JE(t){Jr=new xn(75,window.innerWidth/window.innerHeight,1,3e4),Jr.position.z=1e3,Ua=new A0,ii=new C0,ii.setPixelRatio(window.devicePixelRatio),ii.setSize(window.innerWidth,window.innerHeight),t.appendChild(ii.domElement);const e=new $E(Ua,Jr),n=new ys(new xe(window.innerWidth,window.innerHeight),3,0,0),i=new WE(.9);i.uniforms.damp.value=.975,$s=new qE(ii),$s.addPass(e),$s.addPass(n),$s.addPass(i),Ua.background=new Ge("black"),new UE(Jr,ii.domElement),eT(),Ao.uniforms.positionTex.value=ti.texture,document.body.addEventListener("pointermove",sT),window.addEventListener("resize",rT);const r={separation:20,alignment:50,cohesion:50,freedom:.9};(function(){Lt.separationDistance.value=r.separation,Lt.alignmentDistance.value=r.alignment,Lt.cohesionDistance.value=r.cohesion,Lt.freedomFactor.value=r.freedom})(),tT(),L0()}function eT(){Pn=new BE(Co,Co,ii),ii.capabilities.isWebGL2===!1&&Pn.setDataType(vs);const t=Pn.createTexture(),e=Pn.createTexture();nT(t),iT(e),yi=Pn.addVariable("textureVelocity",YE,e),ti=Pn.addVariable("texturePosition",KE,t),Pn.setVariableDependencies(yi,[ti,yi]),Pn.setVariableDependencies(ti,[ti,yi]),sr=ti.material.uniforms,Lt=yi.material.uniforms,sr.time={value:0},sr.delta={value:0},Lt.time={value:1},Lt.delta={value:0},Lt.testing={value:1},Lt.separationDistance={value:1},Lt.alignmentDistance={value:1},Lt.cohesionDistance={value:1},Lt.freedomFactor={value:1},Lt.predator={value:new k},yi.material.defines.BOUNDS=ro.toFixed(2),yi.wrapS=ir,yi.wrapT=ir,ti.wrapS=ir,ti.wrapT=ir;const n=Pn.init();n!==null&&console.error(n)}function tT(){const e=new Float32Array(Up*3*1),n=window.innerHeight,i=n/2,r=new Xn;for(let o=0;o<Up;o++)for(let a=0;a<1;a++)e[o*3*1+a*3]=Math.random()*n-i,e[o*3*1+a*3+1]=Math.random()*n-i,e[o*3*1+a*3+2]=Math.random()*n-i;r.setAttribute("position",new Fn(e,3));const s=new kE(r,Ao);Ua.add(s)}function nT(t){const e=t.image.data;for(let n=0,i=e.length;n<i;n+=4){const r=Math.random()*ro-Hu,s=Math.random()*ro-Hu,o=Math.random()*ro-Hu;e[n+0]=r,e[n+1]=s,e[n+2]=o,e[n+3]=1}}function iT(t){const e=t.image.data;for(let n=0,i=e.length;n<i;n+=4){const r=Math.random()-.5,s=Math.random()-.5,o=Math.random()-.5;e[n+0]=r*10,e[n+1]=s*10,e[n+2]=o*10,e[n+3]=1}}function rT(){rd=window.innerWidth/2,sd=window.innerHeight/2,Jr.aspect=window.innerWidth/window.innerHeight,Jr.updateProjectionMatrix(),ii.setSize(window.innerWidth,window.innerHeight)}function sT(t){t.isPrimary!==!1&&(Zc=t.clientX-rd,Qc=t.clientY-sd)}function L0(){requestAnimationFrame(L0),oT()}function oT(){const t=performance.now();let e=(t-Bp)/1e3;e>1&&(e=1),Bp=t,sr.time.value=t,sr.delta.value=e,Lt.time.value=t,Lt.delta.value=e,sr.time.value=t,sr.delta.value=e,Lt.predator.value.set(.5*Zc/rd,-.5*Qc/sd,0),Zc=1e4,Qc=1e4,Pn.compute(),Ao.uniforms.positionTex.value=Pn.getCurrentRenderTarget(ti).texture,Ao.uniforms.resolution.value.set(Co,Co),$s.render()}function aT(){Fe.useState(!1);let t=!1;return Fe.useEffect(()=>{const e=document.getElementById("particle-canvas");t||(JE(e),t=!0)},[]),Or(ov,{children:[Be("div",{style:{position:"fixed",zIndex:"-100"},id:"particle-canvas"}),Be(Ux,{})]})}Wu.createRoot(document.getElementById("root")).render(Be(J0.StrictMode,{children:Be(aT,{})}));
